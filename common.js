...
(function () {
  ...
  const WL_API = "https://elite-haven.onrender.com/wishlist";
  ...
  window.EH.INQUIRY_API_URL = "https://elite-haven.onrender.com/inquiries";
  ...
  window.EH.loadAllProperties = async function () {
    ...
    const url = "https://elite-haven.onrender.com/properties";
  ...
  window.EH.updateProperty = async function (id, patch) {
    const url = `https://elite-haven.onrender.com/properties/${encodeURIComponent(id)}`;
